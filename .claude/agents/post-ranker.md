...
| 8 | **Brand Fit** | Does this sound like Grey AI — sharp, direct, human, slightly provocative? Not corporate, not neutral, not analyst-like? **Auto-fail to 3/10** if the topic is inside-baseball with no clear "what changes for a founder or SMB operator" angle. April 13 audit confirmed: NLRB labor law, government ethics disputes, enterprise fraud frameworks, and AI safety internals all collapsed to 0% ER. The test: "Would a founder running a 10-50 person company change a decision based on this?" If no, auto-fail. |
...
| 10 | **Format Variety** | Does the brief recommend a format different from the last 3 published posts? 1-3 = same as last 3, 4-6 = same as last 1-2, 7-10 = different format. **+2 boost** if the brief recommends carousel format (April 13 audit: Grey AI carousel ER is 4.6x higher than text; 0 carousels were posted in the Apr 6–10 period and average impressions dropped 68%). |
