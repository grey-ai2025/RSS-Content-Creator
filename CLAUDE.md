...
- `.claude/agents/` — Agent definitions (seo-researcher, news-researcher, draft-writer, post-ranker).
...
5. **Review & Publish** — I review the top-ranked draft, edit as needed, and post manually to LinkedIn.
