...
2. **SEO Keywords** — The `seo-researcher` agent uses Playwright (browser automation) to scrape Google Trends and Google News as its primary data source, supplemented by web searches for LinkedIn-specific hashtag and engagement data. Saves a structured keywords file to `content/seo/`.
